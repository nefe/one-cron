...
describe('cronValidate', () => {
  it('week schedule', () => {
    ...
    expect(cronValidate('0 0 2 ? * 0,1,2,3,4,5,6', DayOfWeekType.Linux)).toBe(true);
    expect(cronValidate('0 0 2 ? * 0,1,2,3,4,5,6', DayOfWeekType.Spring)).toBe(false);
    expect(cronValidate('0 0 2 ? * 0,1,2,3,4,5,6', DayOfWeekType.Quartz)).toBe(false);
    expect(cronValidate('0 0 2 ? * 7,8')).toBe(false);
    ...
    expect(cronValidate('0 0 2 ? * 6,0', DayOfWeekType.Linux)).toBe(false);
    // 测试strictValidate为false
    expect(cronValidate('0 0 2 ? * 6,0', DayOfWeekType.Linux, false)).toBe(true);
  });
});
