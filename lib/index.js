(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("Antd"), require("Moment"), require("lodash"), require("react"));
	else if(typeof define === 'function' && define.amd)
		define(["Antd", "Moment", "lodash", "react"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("Antd"), require("Moment"), require("lodash"), require("react")) : factory(root["Antd"], root["Moment"], root["lodash"], root["React"]);
    ...
    OneCron.prototype.render = function () {
        ...
        return (React.createElement("span", { className: "schedule-period" },
            ...
            !!showCheckbox && (React.createElement(antd_1.Checkbox, { onChange: function (e) {
                    ...
                    _this.triggerChange();
                }, disabled: cron.periodType !== cronUtils_1.PeriodType.day, checked: cron.periodType !== cronUtils_1.PeriodType.day ? true : cron.isSchedule }, I18N.timing)),
            this.renderDetail()));
    };
